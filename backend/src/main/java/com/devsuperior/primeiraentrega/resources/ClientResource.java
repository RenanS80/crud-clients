...
public class ClientResource {
	...
	// Endpoint para busca paginada de clientes
	@GetMapping
	...
	// Endpoint para busca de clientes por id
	@GetMapping(value = "/{id}")
	...
	// Endpoint para inserção de um novo cliente
	@PostMapping
	...
	// Endpoint para deleção de cliente
